...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'events_proposal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='proposals', to=orm['events.Session'])),
        ...
        db.send_create_signal(u'events', ['Proposal'])

    def backwards(self, orm):
        # Deleting model 'Proposal'
        db.delete_table(u'events_proposal')
